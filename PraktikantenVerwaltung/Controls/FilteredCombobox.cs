...
namespace PraktikantenVerwaltung.Controls
{
    public class FilteredCombobox : ComboBox
    {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="FilteredComboBox" />.
        /// </summary>
        ...
        private void RegisterIsCaseSensitiveChangeNotification()
        {
            DependencyPropertyDescriptor.FromProperty(
                ...
                typeof(FilteredCombobox)).AddValueChanged(
        ...
        private bool FilterPredicate(object value)
        {
            ...
            return student.MatrikelNr.ToString().StartsWith(prefix,
                                               !IsCaseSensitive,
